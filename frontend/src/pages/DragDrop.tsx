  ...
  return (
    <Background>
      ...
      <div className="relative h-[67.5rem] w-[120rem]">
        <div className="absolute left-[21em] top-[15rem] h-[25rem] w-[25rem] rounded-full border-4 border-dashed border-black bg-white opacity-80 shadow backdrop-blur-sm" />
